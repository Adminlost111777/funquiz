...
urlpatterns = [
    ...
    path('physicsgame_quiz/',views.physicsgame_quiz,name='physicsgame'),
    ...
    path('physics_quiz/<uuid:track_id>/',views.physics_quiz,name='physics'),
    path('physics2_quiz/<uuid:track_id>/',views.physics_quiz,name='physics2'),
