...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('myapp', '0054_physics10_correct_answer_physics10_option_a_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('correct_answer', models.IntegerField(blank=True, choices=[(1, 'Option A'), (2, 'Option B'), (3, 'Option C'), (4, 'Option D')], null=True)),
            ],
        ),
    ]
